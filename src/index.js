...
function handleScroll() {
  ...
  milestones.forEach((milestone,index) => {
    ...
    } else if (!milestone.classList.contains('scrolled') && index !== 0 && distanceScrolled > milestone.offsetTop + milestone.parentElement.offsetTop + milestone.parentElement.offsetParent.offsetTop - (window.innerHeight / 2)) {
